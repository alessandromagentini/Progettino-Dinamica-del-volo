...
if E < 0    % orbita ellittica/circolare
    ...
    xi0 = 2*atan(sqrt((1 + e)/(1 - e)) * tan(TA0/2));
    % Anomalia media iniziale
    M_e0 = xi0 - e*sin(xi0);
    % tempo dal perigeo iniziale
    t0 = M_e0*T/(2*pi); 
    ...
    obj_param = struct("r0_vec",r, "v0_vec",v, "h_vec",h, "E",E, ...
                       ...
                       "TA0",rad2deg(TA0), "xi0",rad2deg(xi0), "M_e0",rad2deg(M_e0), "t0",t0, ...
                       "mu",mu, "type",type);
